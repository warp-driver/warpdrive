...
#[utoipa::path(
    ...
    description = "Uploads a component file to be used in a WarpDrive service. Returns a digest that can be used to reference the uploaded component in service configurations."
)]
#[axum::debug_handler]
