...
impl SimpleStellarSubmitXlmClient {
    ...
    pub async fn wait_for_triggered_event_id(
        ...
        // Filter on [Symbol("triggered"), U64(trigger_id)] so we only
        // see our test's specific trigger.
...
/// contract event. The matching topic chain is
