...
use crate::bindings::{
    aggregator::world::warpdrive::vectr::input as aggregator_vectr_input,
...
impl TryFrom<warpdrive_types::TriggerConfig> for aggregator_vectr_input::TriggerConfig {
    type Error = anyhow::Error;

    fn try_from(config: warpdrive_types::TriggerConfig) -> Result<Self, Self::Error> {
        Ok(aggregator_vectr_input::TriggerConfig {
...
impl TryFrom<warpdrive_types::TriggerData> for aggregator_vectr_input::TriggerData {
    type Error = anyhow::Error;
    ...
    fn try_from(src: warpdrive_types::TriggerData) -> Result<Self, Self::Error> {
        match src {
            warpdrive_types::TriggerData::EvmContractEvent {
                ...
                block_timestamp,
                tx_index,
            } => Ok(aggregator_vectr_input::TriggerData::EvmContractEvent(
            ...
            warpdrive_types::TriggerData::CosmosContractEvent {
                ...
                event_index,
                block_height,
            } => Ok(aggregator_vectr_input::TriggerData::CosmosContractEvent(
            ...
            warpdrive_types::TriggerData::BlockInterval {
                chain,
                block_height,
            } => Ok(aggregator_vectr_input::TriggerData::BlockInterval(
            ...
            warpdrive_types::TriggerData::Cron { trigger_time } => Ok(
                aggregator_vectr_input::TriggerData::Cron(aggregator_events::TriggerDataCron {
                    trigger_time: trigger_time.into(),
                }),
            ),
            warpdrive_types::TriggerData::AtProtoEvent {
                ...
                Ok(aggregator_vectr_input::TriggerData::AtprotoEvent(
            ...
            warpdrive_types::TriggerData::Raw(data) => {
                Ok(aggregator_vectr_input::TriggerData::Raw(data))
            }
        }
    }
}
